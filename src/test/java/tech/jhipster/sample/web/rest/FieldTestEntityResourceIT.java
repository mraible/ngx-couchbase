...
class FieldTestEntityResourceIT {
    ...
    private static final String DEFAULT_NUMBER_PATTERN_TOM = "81";
    private static final String UPDATED_NUMBER_PATTERN_TOM = "45";

    private static final String DEFAULT_NUMBER_PATTERN_REQUIRED_TOM = "6086";
    private static final String UPDATED_NUMBER_PATTERN_REQUIRED_TOM = "0748";
    ...
    public void initTest() {
        fieldTestEntityRepository.deleteAll();
    ...
    void createFieldTestEntityWithExistingId() throws Exception {
        ...
        fieldTestEntity.setId("existing_id");
    ...
    @Test
    void getAllFieldTestEntities() throws Exception {
        // Initialize the database
        fieldTestEntityRepository.save(fieldTestEntity);

        // Get all the fieldTestEntityList
        restFieldTestEntityMockMvc
            .perform(get("/api/field-test-entities?sort=id,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(fieldTestEntity.getId())))
            .andExpect(jsonPath("$.[*].stringTom").value(hasItem(DEFAULT_STRING_TOM)))
            .andExpect(jsonPath("$.[*].stringRequiredTom").value(hasItem(DEFAULT_STRING_REQUIRED_TOM)))
            .andExpect(jsonPath("$.[*].stringMinlengthTom").value(hasItem(DEFAULT_STRING_MINLENGTH_TOM)))
            .andExpect(jsonPath("$.[*].stringMaxlengthTom").value(hasItem(DEFAULT_STRING_MAXLENGTH_TOM)))
            .andExpect(jsonPath("$.[*].stringPatternTom").value(hasItem(DEFAULT_STRING_PATTERN_TOM)))
            .andExpect(jsonPath("$.[*].numberPatternTom").value(hasItem(DEFAULT_NUMBER_PATTERN_TOM)))
            .andExpect(jsonPath("$.[*].numberPatternRequiredTom").value(hasItem(DEFAULT_NUMBER_PATTERN_REQUIRED_TOM)))
            ...
            .andExpect(jsonPath("$.[*].bigDecimalRequiredTom").value(hasItem(sameNumber(DEFAULT_BIG_DECIMAL_REQUIRED_TOM))))
            .andExpect(jsonPath("$.[*].bigDecimalMinTom").value(hasItem(sameNumber(DEFAULT_BIG_DECIMAL_MIN_TOM))))
            .andExpect(jsonPath("$.[*].bigDecimalMaxTom").value(hasItem(sameNumber(DEFAULT_BIG_DECIMAL_MAX_TOM))))
            ...
            .andExpect(jsonPath("$.[*].uuidTom").value(hasItem(DEFAULT_UUID_TOM.toString())))
            .andExpect(jsonPath("$.[*].uuidRequiredTom").value(hasItem(DEFAULT_UUID_REQUIRED_TOM.toString())))
    ...
    @Test
    void getFieldTestEntity() throws Exception {
        // Initialize the database
        fieldTestEntityRepository.save(fieldTestEntity);

        // Get the fieldTestEntity
        restFieldTestEntityMockMvc
            .perform(get("/api/field-test-entities/{id}", fieldTestEntity.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(fieldTestEntity.getId()))
            .andExpect(jsonPath("$.stringTom").value(DEFAULT_STRING_TOM))
            .andExpect(jsonPath("$.stringRequiredTom").value(DEFAULT_STRING_REQUIRED_TOM))
            .andExpect(jsonPath("$.stringMinlengthTom").value(DEFAULT_STRING_MINLENGTH_TOM))
            .andExpect(jsonPath("$.stringMaxlengthTom").value(DEFAULT_STRING_MAXLENGTH_TOM))
            .andExpect(jsonPath("$.stringPatternTom").value(DEFAULT_STRING_PATTERN_TOM))
            .andExpect(jsonPath("$.numberPatternTom").value(DEFAULT_NUMBER_PATTERN_TOM))
            .andExpect(jsonPath("$.numberPatternRequiredTom").value(DEFAULT_NUMBER_PATTERN_REQUIRED_TOM))
            ...
            .andExpect(jsonPath("$.bigDecimalRequiredTom").value(sameNumber(DEFAULT_BIG_DECIMAL_REQUIRED_TOM)))
            .andExpect(jsonPath("$.bigDecimalMinTom").value(sameNumber(DEFAULT_BIG_DECIMAL_MIN_TOM)))
            .andExpect(jsonPath("$.bigDecimalMaxTom").value(sameNumber(DEFAULT_BIG_DECIMAL_MAX_TOM)))
            ...
            .andExpect(jsonPath("$.uuidTom").value(DEFAULT_UUID_TOM.toString()))
            .andExpect(jsonPath("$.uuidRequiredTom").value(DEFAULT_UUID_REQUIRED_TOM.toString()))
    ...
    @Test
    void getNonExistingFieldTestEntity() throws Exception {
        // Get the fieldTestEntity
        restFieldTestEntityMockMvc.perform(get("/api/field-test-entities/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }

    @Test
    void updateFieldTestEntity() throws Exception {
        // Initialize the database
        fieldTestEntityRepository.save(fieldTestEntity);
    ...
    @Test
    void updateNonExistingFieldTestEntity() throws Exception {
        int databaseSizeBeforeUpdate = fieldTestEntityRepository.findAll().size();
    ...
    void partialUpdateFieldTestEntityWithPatch() throws Exception {
        ...
        restFieldTestEntityMockMvc
            .perform(
                patch("/api/field-test-entities")
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(partialUpdatedFieldTestEntity))
            )
            .andExpect(status().isOk());
    ...
    @Test
    void partialUpdateFieldTestEntityShouldThrown() throws Exception {
        // Update the fieldTestEntity without id should throw
        FieldTestEntity partialUpdatedFieldTestEntity = new FieldTestEntity();
    ...
    @Test
    void deleteFieldTestEntity() throws Exception {
        // Initialize the database
        fieldTestEntityRepository.save(fieldTestEntity);
        ...
        restFieldTestEntityMockMvc
            .perform(delete("/api/field-test-entities/{id}", fieldTestEntity.getId()).accept(MediaType.APPLICATION_JSON))
