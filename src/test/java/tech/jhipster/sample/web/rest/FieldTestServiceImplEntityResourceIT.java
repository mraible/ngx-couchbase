...
class FieldTestServiceImplEntityResourceIT {
    ...
    public void initTest() {
        fieldTestServiceImplEntityRepository.deleteAll();
    ...
    void createFieldTestServiceImplEntity() throws Exception {
        ...
        restFieldTestServiceImplEntityMockMvc
            .perform(
    ...
    void createFieldTestServiceImplEntityWithExistingId() throws Exception {
        ...
        fieldTestServiceImplEntity.setId("existing_id");
    ...
    @Test
    void getAllFieldTestServiceImplEntities() throws Exception {
        // Initialize the database
        fieldTestServiceImplEntityRepository.save(fieldTestServiceImplEntity);

        // Get all the fieldTestServiceImplEntityList
        restFieldTestServiceImplEntityMockMvc
            .perform(get("/api/field-test-service-impl-entities?sort=id,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(fieldTestServiceImplEntity.getId())))
            .andExpect(jsonPath("$.[*].stringMika").value(hasItem(DEFAULT_STRING_MIKA)))
            .andExpect(jsonPath("$.[*].stringRequiredMika").value(hasItem(DEFAULT_STRING_REQUIRED_MIKA)))
            .andExpect(jsonPath("$.[*].stringMinlengthMika").value(hasItem(DEFAULT_STRING_MINLENGTH_MIKA)))
            .andExpect(jsonPath("$.[*].stringMaxlengthMika").value(hasItem(DEFAULT_STRING_MAXLENGTH_MIKA)))
            .andExpect(jsonPath("$.[*].stringPatternMika").value(hasItem(DEFAULT_STRING_PATTERN_MIKA)))
            ...
            .andExpect(jsonPath("$.[*].bigDecimalRequiredMika").value(hasItem(sameNumber(DEFAULT_BIG_DECIMAL_REQUIRED_MIKA))))
            .andExpect(jsonPath("$.[*].bigDecimalMinMika").value(hasItem(sameNumber(DEFAULT_BIG_DECIMAL_MIN_MIKA))))
            .andExpect(jsonPath("$.[*].bigDecimalMaxMika").value(hasItem(sameNumber(DEFAULT_BIG_DECIMAL_MAX_MIKA))))
            ...
            .andExpect(jsonPath("$.[*].durationMika").value(hasItem(DEFAULT_DURATION_MIKA.toString())))
            .andExpect(jsonPath("$.[*].durationRequiredMika").value(hasItem(DEFAULT_DURATION_REQUIRED_MIKA.toString())))
            ...
            .andExpect(jsonPath("$.[*].uuidMika").value(hasItem(DEFAULT_UUID_MIKA.toString())))
            .andExpect(jsonPath("$.[*].uuidRequiredMika").value(hasItem(DEFAULT_UUID_REQUIRED_MIKA.toString())))
    ...
    @Test
    void getFieldTestServiceImplEntity() throws Exception {
        // Initialize the database
        fieldTestServiceImplEntityRepository.save(fieldTestServiceImplEntity);

        // Get the fieldTestServiceImplEntity
        restFieldTestServiceImplEntityMockMvc
            .perform(get("/api/field-test-service-impl-entities/{id}", fieldTestServiceImplEntity.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(fieldTestServiceImplEntity.getId()))
            .andExpect(jsonPath("$.stringMika").value(DEFAULT_STRING_MIKA))
            .andExpect(jsonPath("$.stringRequiredMika").value(DEFAULT_STRING_REQUIRED_MIKA))
            .andExpect(jsonPath("$.stringMinlengthMika").value(DEFAULT_STRING_MINLENGTH_MIKA))
            .andExpect(jsonPath("$.stringMaxlengthMika").value(DEFAULT_STRING_MAXLENGTH_MIKA))
            .andExpect(jsonPath("$.stringPatternMika").value(DEFAULT_STRING_PATTERN_MIKA))
            ...
            .andExpect(jsonPath("$.bigDecimalRequiredMika").value(sameNumber(DEFAULT_BIG_DECIMAL_REQUIRED_MIKA)))
            .andExpect(jsonPath("$.bigDecimalMinMika").value(sameNumber(DEFAULT_BIG_DECIMAL_MIN_MIKA)))
            .andExpect(jsonPath("$.bigDecimalMaxMika").value(sameNumber(DEFAULT_BIG_DECIMAL_MAX_MIKA)))
            ...
            .andExpect(jsonPath("$.durationMika").value(DEFAULT_DURATION_MIKA.toString()))
            .andExpect(jsonPath("$.durationRequiredMika").value(DEFAULT_DURATION_REQUIRED_MIKA.toString()))
            ...
            .andExpect(jsonPath("$.uuidMika").value(DEFAULT_UUID_MIKA.toString()))
            .andExpect(jsonPath("$.uuidRequiredMika").value(DEFAULT_UUID_REQUIRED_MIKA.toString()))
    ...
    @Test
    void getNonExistingFieldTestServiceImplEntity() throws Exception {
        // Get the fieldTestServiceImplEntity
        restFieldTestServiceImplEntityMockMvc
            .perform(get("/api/field-test-service-impl-entities/{id}", Long.MAX_VALUE))
            .andExpect(status().isNotFound());
    }

    @Test
    void updateFieldTestServiceImplEntity() throws Exception {
        // Initialize the database
        fieldTestServiceImplEntityRepository.save(fieldTestServiceImplEntity);
        ...
        restFieldTestServiceImplEntityMockMvc
            .perform(
                put("/api/field-test-service-impl-entities")
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    void updateNonExistingFieldTestServiceImplEntity() throws Exception {
        int databaseSizeBeforeUpdate = fieldTestServiceImplEntityRepository.findAll().size();
    ...
    void partialUpdateFieldTestServiceImplEntityWithPatch() throws Exception {
        ...
        restFieldTestServiceImplEntityMockMvc
            .perform(
                patch("/api/field-test-service-impl-entities")
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(partialUpdatedFieldTestServiceImplEntity))
            )
            .andExpect(status().isOk());
    ...
    @Test
    void partialUpdateFieldTestServiceImplEntityShouldThrown() throws Exception {
        // Update the fieldTestServiceImplEntity without id should throw
        FieldTestServiceImplEntity partialUpdatedFieldTestServiceImplEntity = new FieldTestServiceImplEntity();
    ...
    @Test
    void deleteFieldTestServiceImplEntity() throws Exception {
        // Initialize the database
        fieldTestServiceImplEntityRepository.save(fieldTestServiceImplEntity);
        ...
        restFieldTestServiceImplEntityMockMvc
            .perform(
                delete("/api/field-test-service-impl-entities/{id}", fieldTestServiceImplEntity.getId()).accept(MediaType.APPLICATION_JSON)
            )
