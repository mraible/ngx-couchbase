...
class FieldTestInfiniteScrollEntityResourceIT {
    ...
    public void initTest() {
        fieldTestInfiniteScrollEntityRepository.deleteAll();
    ...
    void createFieldTestInfiniteScrollEntity() throws Exception {
        ...
        restFieldTestInfiniteScrollEntityMockMvc
            .perform(
    ...
    void createFieldTestInfiniteScrollEntityWithExistingId() throws Exception {
        ...
        fieldTestInfiniteScrollEntity.setId("existing_id");
    ...
    @Test
    void getAllFieldTestInfiniteScrollEntities() throws Exception {
        // Initialize the database
        fieldTestInfiniteScrollEntityRepository.save(fieldTestInfiniteScrollEntity);

        // Get all the fieldTestInfiniteScrollEntityList
        restFieldTestInfiniteScrollEntityMockMvc
            .perform(get("/api/field-test-infinite-scroll-entities?sort=id,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(fieldTestInfiniteScrollEntity.getId())))
            .andExpect(jsonPath("$.[*].stringHugo").value(hasItem(DEFAULT_STRING_HUGO)))
            .andExpect(jsonPath("$.[*].stringRequiredHugo").value(hasItem(DEFAULT_STRING_REQUIRED_HUGO)))
            .andExpect(jsonPath("$.[*].stringMinlengthHugo").value(hasItem(DEFAULT_STRING_MINLENGTH_HUGO)))
            .andExpect(jsonPath("$.[*].stringMaxlengthHugo").value(hasItem(DEFAULT_STRING_MAXLENGTH_HUGO)))
            .andExpect(jsonPath("$.[*].stringPatternHugo").value(hasItem(DEFAULT_STRING_PATTERN_HUGO)))
            ...
            .andExpect(jsonPath("$.[*].bigDecimalRequiredHugo").value(hasItem(sameNumber(DEFAULT_BIG_DECIMAL_REQUIRED_HUGO))))
            .andExpect(jsonPath("$.[*].bigDecimalMinHugo").value(hasItem(sameNumber(DEFAULT_BIG_DECIMAL_MIN_HUGO))))
            .andExpect(jsonPath("$.[*].bigDecimalMaxHugo").value(hasItem(sameNumber(DEFAULT_BIG_DECIMAL_MAX_HUGO))))
            ...
            .andExpect(jsonPath("$.[*].durationHugo").value(hasItem(DEFAULT_DURATION_HUGO.toString())))
            .andExpect(jsonPath("$.[*].durationRequiredHugo").value(hasItem(DEFAULT_DURATION_REQUIRED_HUGO.toString())))
            ...
            .andExpect(jsonPath("$.[*].uuidHugo").value(hasItem(DEFAULT_UUID_HUGO.toString())))
            .andExpect(jsonPath("$.[*].uuidRequiredHugo").value(hasItem(DEFAULT_UUID_REQUIRED_HUGO.toString())))
    ...
    @Test
    void getFieldTestInfiniteScrollEntity() throws Exception {
        // Initialize the database
        fieldTestInfiniteScrollEntityRepository.save(fieldTestInfiniteScrollEntity);

        // Get the fieldTestInfiniteScrollEntity
        restFieldTestInfiniteScrollEntityMockMvc
            .perform(get("/api/field-test-infinite-scroll-entities/{id}", fieldTestInfiniteScrollEntity.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(fieldTestInfiniteScrollEntity.getId()))
            .andExpect(jsonPath("$.stringHugo").value(DEFAULT_STRING_HUGO))
            .andExpect(jsonPath("$.stringRequiredHugo").value(DEFAULT_STRING_REQUIRED_HUGO))
            .andExpect(jsonPath("$.stringMinlengthHugo").value(DEFAULT_STRING_MINLENGTH_HUGO))
            .andExpect(jsonPath("$.stringMaxlengthHugo").value(DEFAULT_STRING_MAXLENGTH_HUGO))
            .andExpect(jsonPath("$.stringPatternHugo").value(DEFAULT_STRING_PATTERN_HUGO))
            ...
            .andExpect(jsonPath("$.bigDecimalRequiredHugo").value(sameNumber(DEFAULT_BIG_DECIMAL_REQUIRED_HUGO)))
            .andExpect(jsonPath("$.bigDecimalMinHugo").value(sameNumber(DEFAULT_BIG_DECIMAL_MIN_HUGO)))
            .andExpect(jsonPath("$.bigDecimalMaxHugo").value(sameNumber(DEFAULT_BIG_DECIMAL_MAX_HUGO)))
            ...
            .andExpect(jsonPath("$.durationHugo").value(DEFAULT_DURATION_HUGO.toString()))
            .andExpect(jsonPath("$.durationRequiredHugo").value(DEFAULT_DURATION_REQUIRED_HUGO.toString()))
            ...
            .andExpect(jsonPath("$.uuidHugo").value(DEFAULT_UUID_HUGO.toString()))
            .andExpect(jsonPath("$.uuidRequiredHugo").value(DEFAULT_UUID_REQUIRED_HUGO.toString()))
    ...
    @Test
    void getNonExistingFieldTestInfiniteScrollEntity() throws Exception {
        // Get the fieldTestInfiniteScrollEntity
        restFieldTestInfiniteScrollEntityMockMvc
            .perform(get("/api/field-test-infinite-scroll-entities/{id}", Long.MAX_VALUE))
            .andExpect(status().isNotFound());
    }

    @Test
    void updateFieldTestInfiniteScrollEntity() throws Exception {
        // Initialize the database
        fieldTestInfiniteScrollEntityRepository.save(fieldTestInfiniteScrollEntity);
        ...
        restFieldTestInfiniteScrollEntityMockMvc
            .perform(
                put("/api/field-test-infinite-scroll-entities")
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    void updateNonExistingFieldTestInfiniteScrollEntity() throws Exception {
        int databaseSizeBeforeUpdate = fieldTestInfiniteScrollEntityRepository.findAll().size();
    ...
    void partialUpdateFieldTestInfiniteScrollEntityWithPatch() throws Exception {
        ...
        restFieldTestInfiniteScrollEntityMockMvc
            .perform(
                patch("/api/field-test-infinite-scroll-entities")
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(partialUpdatedFieldTestInfiniteScrollEntity))
            )
            .andExpect(status().isOk());
    ...
    @Test
    void partialUpdateFieldTestInfiniteScrollEntityShouldThrown() throws Exception {
        // Update the fieldTestInfiniteScrollEntity without id should throw
        FieldTestInfiniteScrollEntity partialUpdatedFieldTestInfiniteScrollEntity = new FieldTestInfiniteScrollEntity();
    ...
    @Test
    void deleteFieldTestInfiniteScrollEntity() throws Exception {
        // Initialize the database
        fieldTestInfiniteScrollEntityRepository.save(fieldTestInfiniteScrollEntity);
        ...
        restFieldTestInfiniteScrollEntityMockMvc
            .perform(
                delete("/api/field-test-infinite-scroll-entities/{id}", fieldTestInfiniteScrollEntity.getId())
