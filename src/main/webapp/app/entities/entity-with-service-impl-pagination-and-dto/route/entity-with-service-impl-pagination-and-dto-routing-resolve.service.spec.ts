...
describe('Service Tests', () => {
  describe('EntityWithServiceImplPaginationAndDTO routing resolve service', () => {
    ...
    let resultEntityWithServiceImplPaginationAndDTO: IEntityWithServiceImplPaginationAndDTO | undefined;
    ...
    describe('resolve', () => {
      it('should return existing IEntityWithServiceImplPaginationAndDTO for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new EntityWithServiceImplPaginationAndDTO(id) })));
        ...
        expect(resultEntityWithServiceImplPaginationAndDTO).toEqual(new EntityWithServiceImplPaginationAndDTO('123'));
      });

      it('should return new IEntityWithServiceImplPaginationAndDTO if id is not provided', () => {
        // GIVEN
        ...
        expect(resultEntityWithServiceImplPaginationAndDTO).toEqual(new EntityWithServiceImplPaginationAndDTO());
      });
