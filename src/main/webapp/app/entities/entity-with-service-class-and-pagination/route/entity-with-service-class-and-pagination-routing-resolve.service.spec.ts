...
describe('Service Tests', () => {
  describe('EntityWithServiceClassAndPagination routing resolve service', () => {
    ...
    let resultEntityWithServiceClassAndPagination: IEntityWithServiceClassAndPagination | undefined;
    ...
    describe('resolve', () => {
      it('should return existing IEntityWithServiceClassAndPagination for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new EntityWithServiceClassAndPagination(id) })));
        ...
        expect(resultEntityWithServiceClassAndPagination).toEqual(new EntityWithServiceClassAndPagination('123'));
      });

      it('should return new IEntityWithServiceClassAndPagination if id is not provided', () => {
        // GIVEN
        ...
        expect(resultEntityWithServiceClassAndPagination).toEqual(new EntityWithServiceClassAndPagination());
      });
