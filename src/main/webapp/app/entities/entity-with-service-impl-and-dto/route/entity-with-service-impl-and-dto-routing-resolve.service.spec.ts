...
describe('Service Tests', () => {
  describe('EntityWithServiceImplAndDTO routing resolve service', () => {
    ...
    let resultEntityWithServiceImplAndDTO: IEntityWithServiceImplAndDTO | undefined;
    ...
    describe('resolve', () => {
      it('should return existing IEntityWithServiceImplAndDTO for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new EntityWithServiceImplAndDTO(id) })));
        ...
        expect(resultEntityWithServiceImplAndDTO).toEqual(new EntityWithServiceImplAndDTO('123'));
      });

      it('should return new IEntityWithServiceImplAndDTO if id is not provided', () => {
        // GIVEN
        ...
        expect(resultEntityWithServiceImplAndDTO).toEqual(new EntityWithServiceImplAndDTO());
      });
