...
public class FieldTestServiceClassAndJpaFilteringEntityService {
     ...
     */
    public FieldTestServiceClassAndJpaFilteringEntity save(
     ...
     * @return the persisted entity.
     */
    public Optional<FieldTestServiceClassAndJpaFilteringEntity> partialUpdate(
        FieldTestServiceClassAndJpaFilteringEntity fieldTestServiceClassAndJpaFilteringEntity
    ) {
        log.debug(
        ...
        return fieldTestServiceClassAndJpaFilteringEntityRepository
            ...
            .map(
                existingFieldTestServiceClassAndJpaFilteringEntity -> {
            ...
            .map(fieldTestServiceClassAndJpaFilteringEntityRepository::save);
    }
     ...
     */
    public List<FieldTestServiceClassAndJpaFilteringEntity> findAll() {
     ...
     * @return the entity.
     */
    public Optional<FieldTestServiceClassAndJpaFilteringEntity> findOne(String id) {
    ...
    public void delete(String id) {
        ...
        fieldTestServiceClassAndJpaFilteringEntityRepository.deleteById(id);
    }
}
