...
public class FieldTestMapstructAndServiceClassEntityService {
     ...
     */
    public FieldTestMapstructAndServiceClassEntityDTO save(
        ...
        FieldTestMapstructAndServiceClassEntity fieldTestMapstructAndServiceClassEntity = fieldTestMapstructAndServiceClassEntityMapper.toEntity(
        ...
        return fieldTestMapstructAndServiceClassEntityMapper.toDto(fieldTestMapstructAndServiceClassEntity);
    }
     ...
     * @return the persisted entity.
     */
    public Optional<FieldTestMapstructAndServiceClassEntityDTO> partialUpdate(
        FieldTestMapstructAndServiceClassEntityDTO fieldTestMapstructAndServiceClassEntityDTO
    ) {
        ...
        return fieldTestMapstructAndServiceClassEntityRepository
            ...
            .map(fieldTestMapstructAndServiceClassEntityRepository::save)
     ...
     */
    public List<FieldTestMapstructAndServiceClassEntityDTO> findAll() {
     ...
     * @return the entity.
     */
    public Optional<FieldTestMapstructAndServiceClassEntityDTO> findOne(String id) {
    ...
    public void delete(String id) {
        ...
        fieldTestMapstructAndServiceClassEntityRepository.deleteById(id);
    }
}
