...
public class FieldTestServiceImplEntityServiceImpl implements FieldTestServiceImplEntityService {
    ...
    @Override
    public Optional<FieldTestServiceImplEntity> partialUpdate(FieldTestServiceImplEntity fieldTestServiceImplEntity) {
        ...
        return fieldTestServiceImplEntityRepository
            ...
            .map(
                existingFieldTestServiceImplEntity -> {
            ...
            .map(fieldTestServiceImplEntityRepository::save);
    }
    ...
    @Override
    public Optional<FieldTestServiceImplEntity> findOne(String id) {
