...
public class FieldTestEntity implements Serializable {
    ...
    public static final String PREFIX = "fieldtestentity";
    ...
    @NotNull
    @Field("integer_required_tom")
    private Integer integerRequiredTom;

    @Min(value = 0)
    @Field("integer_min_tom")
    private Integer integerMinTom;

    @Max(value = 100)
    @Field("integer_max_tom")
    ...
    @NotNull
    @Field("instant_required_tom")
    private Instant instantRequiredTom;

    @Field("zoned_date_time_tom")
    private ZonedDateTime zonedDateTimeTom;

    @NotNull
    @Field("zoned_date_time_required_tom")
    ...
    public FieldTestEntity id(String id) {
        this.id = id;
        return this;
    }
