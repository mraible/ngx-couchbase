...
public class FieldTestInfiniteScrollEntity implements Serializable {
    ...
    public static final String PREFIX = "fieldtestinfinitescrollentity";
    ...
    @NotNull
    @Field("string_required_hugo")
    private String stringRequiredHugo;

    @Size(min = 0)
    @Field("string_minlength_hugo")
    private String stringMinlengthHugo;

    @Size(max = 20)
    @Field("string_maxlength_hugo")
    private String stringMaxlengthHugo;

    @Pattern(regexp = "^[a-zA-Z0-9]*$")
    @Field("string_pattern_hugo")
    ...
    @NotNull
    @Field("integer_required_hugo")
    private Integer integerRequiredHugo;

    @Min(value = 0)
    @Field("integer_min_hugo")
    private Integer integerMinHugo;

    @Max(value = 100)
    @Field("integer_max_hugo")
    ...
    @NotNull
    @Field("instante_required_hugo")
    private Instant instanteRequiredHugo;

    @Field("zoned_date_time_hugo")
    private ZonedDateTime zonedDateTimeHugo;

    @NotNull
    @Field("zoned_date_time_required_hugo")
    ...
    public FieldTestInfiniteScrollEntity id(String id) {
        this.id = id;
        return this;
    }
