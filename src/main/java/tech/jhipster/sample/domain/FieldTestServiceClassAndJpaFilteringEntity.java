...
public class FieldTestServiceClassAndJpaFilteringEntity implements Serializable {
    ...
    public static final String PREFIX = "fieldtestserviceclassandjpafilteringentity";
    ...
    @NotNull
    @Field("integer_required_bob")
    private Integer integerRequiredBob;

    @Min(value = 0)
    @Field("integer_min_bob")
    private Integer integerMinBob;

    @Max(value = 100)
    @Field("integer_max_bob")
    ...
    @NotNull
    @Field("instante_required_bob")
    private Instant instanteRequiredBob;

    @Field("zoned_date_time_bob")
    private ZonedDateTime zonedDateTimeBob;

    @NotNull
    @Field("zoned_date_time_required_bob")
    ...
    public FieldTestServiceClassAndJpaFilteringEntity id(String id) {
        this.id = id;
        return this;
    }
